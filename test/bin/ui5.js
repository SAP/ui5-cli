...
test.serial("ui5 imports local installation when found", (t) => {
	const consoleLogStub = sinon.stub(console, "log");
...
test.serial("ui5 imports local installation when found (/w --verbose)", (t) => {
	const consoleLogStub = sinon.stub(console, "log");
	const consoleInfoStub = sinon.stub(console, "info");
...
test.serial("ui5 logs warning when using pre-release Node.js version", (t) => {
	const consoleLogStub = sinon.stub(console, "log");
