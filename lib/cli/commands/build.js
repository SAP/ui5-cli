...
build.builder = function(cli) {
	return cli
		...
		.option("include-dependency", {
			describe: "A list of dependencies to be included into the build process. Using the '*' as value is an" +
				" alias for including all dependencies into the build process. The listed dependencies cannot be" +
