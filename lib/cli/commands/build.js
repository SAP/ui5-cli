...
build.builder = function(cli) {
	return cli
		...
		.option("include-dependency", {
			describe: "A list of dependencies to be included into build process",
			type: "array"
		})
		.option("include-dependency-regexp", {
			describe: "A list of regular expressions defining dependencies to be included into build process",
			type: "array"
		})
		.option("include-dependency-tree", {
			describe: "A list of dependencies to be included into build process including their sub-dependencies",
			type: "array"
		})
		.option("exclude-dependency", {
			describe: "A list of dependencies to be excluded from build process",
			type: "array"
		})
		.option("exclude-dependency-regexp", {
			describe: "A list of regular expressions defining dependencies to be excluded from build process",
			type: "array"
		})
		.option("exclude-dependency-tree", {
			describe: "A list of dependencies to be excluded from build process including their sub-dependencies",
			type: "array"
		})
		.option("dest", {
...
async function handleBuild(argv) {
	...
	const includedDependencies = buildHelper.createDependencyList({
		tree: tree, dependencies: argv["include-dependency"], dependenciesRegExp: argv["include-dependency-regexp"]});
	const includedDependencyTrees = buildHelper.createDependencyList(
		{tree: tree, dependencies: argv["include-dependency-tree"], handleSubtree: true});
	const excludedDependencies = buildHelper.createDependencyList({
		tree: tree, dependencies: argv["exclude-dependency"], dependenciesRegExp: argv["exclude-dependency-regexp"]});
	const excludedDependencyTrees = buildHelper.createDependencyList(
		{tree: tree, dependencies: argv["exclude-dependency-tree"], handleSubtree: true});
	...
	const defaultIncludedDependencyTrees = buildHelper.createDependencyList(
		{tree: tree, dependencies: buildSettings.includeDependencyTree, handleSubtree: true});
